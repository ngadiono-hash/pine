...
int one_minutes_in_millis = 60000
if timenow >= time_close - one_minutes_in_millis
    pC = close - dO
    string _change = pC > 0 ? "+" + str.tostring(pC, "#.##") : str.tostring(pC, "#.##") 
    string _time = str.format_time(time_close, 'HH:mm', 'GMT+7')
    alertmsg = str.format('{0} | {1} | {2} | {3}', syminfo.ticker, _time, _change, str.tostring(close))
